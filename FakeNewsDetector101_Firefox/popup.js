...
function formatReportTime(dt) {
  // dt is like "2025-11-16 16:00:58"
    ...
    data.history.slice(0, 10).forEach((item) => {
      ...
      node.innerHTML = `
        ...
        <div class="hist-body">
          ...
          <div class="hist-time">🕒 ${formatReportTime(item.timestamp)}</div>
        </div>
      `;
